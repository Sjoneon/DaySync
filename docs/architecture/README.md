...
### AI 대화형 일정 관리
- 자연어 처리: "내일 오후 3시에 서원대에서 회의"라고 말하면 자동으로 일정 생성
...
- **[시스템 개요](Design_System_overview.md)** - 전체 시스템 구조, 기술 스택, 데이터 플로우
- **[Android 아키텍처](Design_Android_architecture.md)** - MVVM 패턴, 프로젝트 구조, 주요 컴포넌트
- **[백엔드 아키텍처](Design_Backend_architecture.md)** - FastAPI 구조, API 설계, 비즈니스 로직
- **[데이터베이스 스키마](Design_Database_schema.md)** - ERD, 테이블 구조, 인덱스 전략
