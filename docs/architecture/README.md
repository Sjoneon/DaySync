...
- **[시스템 개요](./architecture/system-overview.md)** - 전체 시스템 구조, 기술 스택, 데이터 플로우
- **[Android 아키텍처](./architecture/android-architecture.md)** - MVVM 패턴, 프로젝트 구조, 주요 컴포넌트
- **[백엔드 아키텍처](./architecture/backend-architecture.md)** - FastAPI 구조, API 설계, 비즈니스 로직
- **[데이터베이스 스키마](./architecture/database-schema.md)** - ERD, 테이블 구조, 인덱스 전략
