...
- **Maps**: Naver Maps API, TMAP API
- **Traffic**: 국토교통부 TAGO API (실시간 버스 정보)
...
**초기 설계의 체계성**
프로젝트 초기 단계에서 더 체계적인 데이터베이스 스키마 설계가 필요했습니다. 개발 중간에 테이블 구조를 여러 차례 수정하면서 마이그레이션 과정에서 어려움을 겪었습니다.

**테스트 자동화**
단위 테스트와 통합 테스트를 초기부터 작성하지 못해 버그 발견이 늦어진 경우가 있었습니다. 향후 프로젝트에서는 TDD 방식을 도입할 계획입니다.

**사용자 피드백 반영**
실제 사용자 테스트를 통한 피드백 수집 및 반영 과정이 부족했습니다. 더 많은 사용자 테스트를 통해 UX를 개선할 필요가 있습니다.
...
- **GitHub**: [Sjoneon](https://github.com/Sjoneon)
